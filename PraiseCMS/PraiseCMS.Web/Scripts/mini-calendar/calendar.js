(function ($) {
    ...
    var defaults = {
        ...
        monthYearSeparator: " ",
        onClickDate: function (date, formatedDate) { },
    ...
    function generateWeekHeaderDOM(currentDate) {
        var str = "";
        str += '<div class="weeks-wrapper calendar-header">';
        str +=
            '<div class="week' +
        ...
        for (var weekDay in dayMap) {
            if (dayMap.hasOwnProperty(weekDay)) {
                str +=
                    '<div class="day calendar-header" data-day="' +
                    weekDay +
                    '">' +
        ...
        monthData.forEach(function (week, weekNo) {
            ...
            week.forEach(function (day, dayNo) {
                ...
                str +=
                    ...
                    today +
                    '" data-date="' + day +
                    '" data-formated-Date="' + formatDate(day) + '" ' +
                    dateDisabled +
                    " ><span>" +
                    day.getDate() +
                    "</span></div>";
    ...
    $.fn.calendar = function (options) {
        ...
        el.off("click", ".day").on("click", ".day", function (e) {
            ...
            var formattedDate = $(this).data("formated-date");
            var isDisabled = $(this).attr("disabled") === "disabled";
            if (isDisabled) return;
            settings.onClickDate(date, formattedDate);
        });
