...
var KTWidgets = function () {
    ...
    var _initDaterangepicker = function () {
        ...
        function cb(start, end, label) {
            var title = label === "Today" ? "Today:" : (label === "Yesterday" ? "Yesterday:" : label + ":");
            var range = "";

            if ((end - start) < 100 || label === "Today" || label === "Yesterday") {
    ...
    var _initStatsWidget9 = function (data) {
    ...
    var _initStatsWidget10 = function (data) {
    ...
    var _initStatsWidget11 = function (data) {
    ...
    var _initStatsWidget12 = function (data) {
    ...
    return {
        init: function () {
            $.get("/Home/WidgetsGraphData", null, function (result) {
                //debugger
                _initStatsWidget9(result.find(x => x.Key === "giving").Data);
                _initStatsWidget12(result.find(x => x.Key === "salvation").Data);
                _initStatsWidget11(result.find(x => x.Key === "attendance").Data);
                _initStatsWidget10(result.find(x => x.Key === "baptism").Data);
            });
